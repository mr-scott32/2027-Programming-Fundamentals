...
#### **Reading from a File** <a href="#reading-from-a-file" id="reading-from-a-file"></a>
...
with open("students.txt", "r") as file:content = file.read()print(content) # Prints entire file as a string

***

#### **Writing to a File** <a href="#writing-to-a-file" id="writing-to-a-file"></a>
...
with open("students.txt", "w") as file:file.write("Alice\nBob\nCharlie\n") # Writes names to file

***

#### **Closing a File** <a href="#closing-a-file" id="closing-a-file"></a>
